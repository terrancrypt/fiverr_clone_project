...
const AdsDefault = () => {
  return (
    <div className="homepage__ads container my-0 mx-auto px-6 sm:px-8 2xl:px-0 py-24">
      <div className="homepage__ads-banner flex flex-start relative lg:h-auto">
        <div className="homepage__ads-text pl-9 lg:pl-20 py-9 z-20">
          ...
          <h2 className="text-white mb-2">Make an incredible logo
          <br />
          <i className="domaine__font">in minutes</i>
          </h2>
          <p className="text-white mb-6">Pre-designed by top talent. Just add your touch</p>
          <NavLink className="homepage__ads-button bg-white">Try Fiverr Logo Maker</NavLink>
        </div>
        <div className="homepage__ads-image absolute top-0 bottom-0 right-0 left-0 flex items-center justify-end overflow-hidden">
            <img className="block object-contain w-full h-full" src="https://fiverr-res.cloudinary.com/q_auto,f_auto,w_1160,dpr_2.0/v1/attachments/generic_asset/asset/b49b1963f5f9008f5ff88bd449ec18f7-1608035772453/logo-maker-banner-wide-desktop-1352-2x.png" alt="" />
        </div>
      </div>
    </div>
  );
