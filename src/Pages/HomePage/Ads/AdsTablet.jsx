    ...
    <div className="homepage__ads container my-0 mx-auto px-6 sm:px-8 2xl:px-0 py-24">
      <div className="homepage__ads-banner flex flex-start relative pb-80 lg:h-auto">
        ...
        <div className="homepage__ads-image absolute bottom-0 right-0 left-0 flex items-center justify-center overflow-hidden">
            <img className="block object-contain w-full h-full" src="https://fiverr-res.cloudinary.com/q_auto,f_auto,w_852,dpr_1.0/v1/attachments/generic_asset/asset/8610b9c7c90c338adc976e96051cbd6c-1608034070829/logo-maker-banner-tablet-852-2x.png" alt="" />
        </div>
      </div>
    </div>
  );
