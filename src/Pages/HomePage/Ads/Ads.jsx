    ...
    <div className="homepage__ads container my-0 mx-auto px-6 sm:px-8 2xl:px-0 relative">
      <div className="homepage__ads-banner flex flex-start">
        ...
        <div className="homepage__ads-image absolute top-0 bottom-0 right-0 left-0 flex items-center justify-end overflow-hidden">
            <img className="block object-contain" src="https://fiverr-res.cloudinary.com/q_auto,f_auto,w_1160,dpr_2.0/v1/attachments/generic_asset/asset/b49b1963f5f9008f5ff88bd449ec18f7-1608035772453/logo-maker-banner-wide-desktop-1352-2x.png" alt="" />
        </div>
      </div>
    </div>
  );
