...
const BusinessItem = () => {
  return (
    <div className="business__item flex flex-col space-y-8">
      <div className="business__item-logo flex items-center space-x-2">
        <svg
          width="178"
          height="22"
          viewBox="0 0 219 27"
        ...
        <span className="text-white font-bold mr-2 px-2 py-0.5 rounded-full">
          NEW
        </span>
      </div>
      <h2 className="business__item-title text-white">
        A solution built for <span>business</span>
      </h2>
      <p className="business__item-desc text-white mr-12">
        Upgrade to a curated experience to access vetted talent and exclusive
        tools
      </p>
      <ul className="business__item-list">
        <li>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
      ...
      <NavLink className="business__item-button text-white">
