...
export default function LoginPageImg() {
  return (
    <div>              <p className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
    Sign In to Fiverr
  </p>
  <div className="">
    <button
  ...
  <div>
    <button
      type="button"
      className="text-black bg-white hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center  "
    >
      <svg
