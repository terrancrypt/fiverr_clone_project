...
<div className="categories__title">
  <div className="container mt-5 sm:mt-3 mb-5 sm:mb-3">
    ...
    <div className="categories__content grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      ...
      <div className="item flex items-center justify-center p-4 border border-gray-200 rounded-md">
        <img
          ...
          className="w-16 h-16"
        />
        <span className="ml-2 text-sm">T-Shirts & Merchandise</span>
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fas"
