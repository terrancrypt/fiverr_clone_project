  ...
  return (
    <div className="bottom mt-4 flex flex-col md:flex-row justify-between items-center">
      ...
      <div className="bottom__right flex justify-between items-center">
        ...
        <div className="flex space-x-4 text-gray-500 text-sm font-bold">
