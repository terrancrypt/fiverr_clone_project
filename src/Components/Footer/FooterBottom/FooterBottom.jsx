...
import FooterBottomGeneral from "./FooterBottomGeneral";
  ...
  return (
    <div className="bottom mt-4 flex flex-col justify-between items-center">
      <div className="bottom__left mb-3 sm:mb-6 flex flex-col sm:flex-row items-center sm:items-end">
        ...
        <span className="pt-3 sm:pt-0 sm:ml-6 text-sm text-gray-400">
          © Fiverr International Ltd. 2023
        </span>
      </div>
      <div className="bottom__right flex flex-col sm:flex-row flex-end items-center sm:-ml-2">
        <FooterBottomSocial />
        <FooterBottomGeneral />
      </div>
    </div>
